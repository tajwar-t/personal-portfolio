/**
 * Editor registration for tajwar-tajim/blog-preview.
 *
...
( function ( blocks, element, blockEditor, i18n ) {
	...
	blocks.registerBlockType( 'tajwar-tajim/blog-preview', {
		edit: function () {
			...
			return el(
				...
				el(
					...
					__( 'Blog Preview (live data)', 'tajwar-tajim' )
				),
				el( ServerSideRender, { block: 'tajwar-tajim/blog-preview' } )
			);
		},
		save: function () {
			return null;
